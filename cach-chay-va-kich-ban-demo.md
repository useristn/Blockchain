...
Trong terminal chạy `npm run node`, Hardhat đã in sẵn danh sách account.

Nên import tối thiểu các account sau:
...
Lưu ý: nếu bạn tắt node và chạy lại thì dữ liệu chain bị reset, cần deploy lại từ đầu.
...
### Giai đoạn 5. Demo cử tri bỏ phiếu
...
### Giai đoạn 6. Demo thêm một cử tri khác
...
### Giai đoạn 7. Demo chặn người không có quyền
